  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>
          <strong>Нужно:</strong> Делать видео-процесс прорисовки и фото «До/После» конкретных зон (например, только одна ключица с контурингом, вторая — без). Это наглядно объясняет клиенту, за что он платит.
        </p>
      </>
    ),
  },
